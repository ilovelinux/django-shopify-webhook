...
class WebhookView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            signals.webhook_received.send_robust(self, request = request, domain = request.webhook_domain, topic = request.webhook_topic, webhook_id = request.webhook_id, data = request.webhook_data)
            getattr(signals, signal_name).send_robust(self, request = request, domain = request.webhook_domain, topic = request.webhook_topic, webhook_id = request.webhook_id, data = request.webhook_data)
